 ...
 * 
 * @param tamElem (int): tamanho em bytes de cada elemento
 * @return (pilha_t *): endereco da primeira posicao na
 * Heap contendo a pilha alocada.
 */
 ...
 * @param x (void *): endereço genérico do elemento a ser adicionado à  
 * pilha especificada
...
/* |pop|
 * Adiciona elemento ao topo da pilha e armazena seu valor na variável especificada
 * 
 * @param p (pilha_t *): pilha da qual será desempilhada o elemento do topo.
 * @param x (void *): endereço da variável na qual será armazenada o valor do
