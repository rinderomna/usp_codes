...
/* |access_element_in_priority_queue|
 * Accesses the element in the passed priority queue at the specified index.
 * Returns that value by storing its information at a specified element pointer. 
 * 
 * @param l (p_queue_t *): pointer to the priority queue to be accessed.
 ...
 */
void access_element_in_priority_queue(p_queue_t *q, int index, void *datum);

/* |remove_element_in_priority_queue|
 * Removes the element the passed priority queue at the specified index.
 * Stores the removed element datum at the specified datum pointer.
 *
 * @param q (list_t *): pointer to the priority queue from which to remove the element at its start.
 ...
 * @param datum (void *): pointer that will receive the removed element datum.
 */
void remove_element_in_priority_queue(p_queue_t *q, int index, void *datum);
