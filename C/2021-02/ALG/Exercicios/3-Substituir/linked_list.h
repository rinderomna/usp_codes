...
/* |create_list|
 * Returns an allocated list of elements. Element type defined at line 1.
 * Initializes size with 0 and all pointers with NULL.
 * 
...
/* |insert_in_list|
 * Insert the passed element in the specified list at the determined index.
 * 
...
/* |access_datum|
 * Changes by reference an element with the datum in the list at the specified index.
 * 
