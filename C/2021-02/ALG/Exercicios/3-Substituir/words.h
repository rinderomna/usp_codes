 ...
 * Returns the respective pointer to allocated string. Also returns by reference
 * a bool integer that indicates 1 (true) is an EOF has been read and 0, otherwise.
 * 
 ...
 * to remove in it. Also changes by reference a occurrences counter. Returns an
...
/* |create_wordlist|
 * Returns an allocated wordlist, whose words vector and n_words are initialized
 * with NULL and 0, respectively.
 * 
